...
Partial Public Class srsdbDataSet
    ...
    Partial Public Class students_tblDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function Addstudents_tblRow(ByVal first_name As String, ByVal last_name As String, ByVal course As String, ByVal gender As String, ByVal phone As String, ByVal department_id As Integer, ByVal profile_id As Integer) As students_tblRow
            Dim rowstudents_tblRow As students_tblRow = CType(Me.NewRow,students_tblRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, first_name, last_name, course, gender, phone, department_id, profile_id}
...
Namespace srsdbDataSetTableAdapters
    ...
    Partial Public Class students_tblTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[students_tbl] WHERE (([id] = @Original_id) AND ([first_name] ="& _ 
                " @Original_first_name) AND ([last_name] = @Original_last_name) AND ([course] = @"& _ 
                "Original_course) AND ([gender] = @Original_gender) AND ([phone] = @Original_phon"& _ 
                "e) AND ([department_id] = @Original_department_id) AND ([profile_id] = @Original"& _ 
                "_profile_id))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[students_tbl] ([first_name], [last_name], [course], [gender], "& _ 
                "[phone], [department_id], [profile_id]) VALUES (@first_name, @last_name, @course"& _ 
                ", @gender, @phone, @department_id, @profile_id);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id, first_name, last_na"& _ 
                "me, course, gender, phone, department_id, profile_id FROM students_tbl WHERE (id"& _ 
                " = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[students_tbl] SET [first_name] = @first_name, [last_name] = @last_n"& _ 
                "ame, [course] = @course, [gender] = @gender, [phone] = @phone, [department_id] ="& _ 
                " @department_id, [profile_id] = @profile_id WHERE (([id] = @Original_id) AND ([f"& _ 
                "irst_name] = @Original_first_name) AND ([last_name] = @Original_last_name) AND ("& _ 
                "[course] = @Original_course) AND ([gender] = @Original_gender) AND ([phone] = @O"& _ 
                "riginal_phone) AND ([department_id] = @Original_department_id) AND ([profile_id]"& _ 
                " = @Original_profile_id));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id, first_name, last_name, course, gender, ph"& _ 
                "one, department_id, profile_id FROM students_tbl WHERE (id = @id)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT id, first_name, last_name, course, gender, phone, department_id, profile_i"& _ 
                "d FROM dbo.students_tbl"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_id As Integer, ByVal Original_first_name As String, ByVal Original_last_name As String, ByVal Original_course As String, ByVal Original_gender As String, ByVal Original_phone As String, ByVal Original_department_id As Integer, ByVal Original_profile_id As Integer) As Integer
            ...
            End If
            Me.Adapter.DeleteCommand.Parameters(6).Value = CType(Original_department_id,Integer)
            Me.Adapter.DeleteCommand.Parameters(7).Value = CType(Original_profile_id,Integer)
        ...
        Public Overloads Overridable Function Insert(ByVal first_name As String, ByVal last_name As String, ByVal course As String, ByVal gender As String, ByVal phone As String, ByVal department_id As Integer, ByVal profile_id As Integer) As Integer
            ...
            End If
            Me.Adapter.InsertCommand.Parameters(5).Value = CType(department_id,Integer)
            Me.Adapter.InsertCommand.Parameters(6).Value = CType(profile_id,Integer)
        ...
        Public Overloads Overridable Function Update( _
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(5).Value = CType(department_id,Integer)
            Me.Adapter.UpdateCommand.Parameters(6).Value = CType(profile_id,Integer)
            ...
            Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_profile_id,Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal first_name As String, ByVal last_name As String, ByVal course As String, ByVal gender As String, ByVal phone As String, ByVal department_id As Integer, ByVal profile_id As Integer, ByVal Original_id As Integer, ByVal Original_first_name As String, ByVal Original_last_name As String, ByVal Original_course As String, ByVal Original_gender As String, ByVal Original_phone As String, ByVal Original_department_id As Integer, ByVal Original_profile_id As Integer) As Integer
            Return Me.Update(first_name, last_name, course, gender, phone, department_id, profile_id, Original_id, Original_first_name, Original_last_name, Original_course, Original_gender, Original_phone, Original_department_id, Original_profile_id, Original_id)
        End Function
    End Class
